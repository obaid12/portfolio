...
const About = () => {
  return (
    <div className='wrapper'>
      ...
      <p>
        I specialize in ReactJS, NextJS, NodeJS, and MongoDB. Collaborating with diverse teams using platforms like GitHub and Bitbucket has honed my communication and teamwork skills. What sets me apart is my genuine passion for programming. I approach projects with a personal commitment to excellence, viewing programming not just as a job but as a fulfilling pursuit. Understanding the importance of maintaining a healthy work-life balance,
      </p>
    </div>
  );
};
