  ...
  return (
    <div className='wrapper flex flex-col md:flex-row items-center gap-10'>
      <div className='w-44 h-44 rounded-full bg-black'>
        <Image
          className='w-full h-full rounded-full border-[2px] boder-blue-600 p-1 object-cover'
          src={my}
          alt="my"
        />
      </div>
      <div className="w-3/4 flex:items-center md:items-start flex-col gap-2">
        <div className=''>
          ...
          I specialize in **ReactJS**, **NextJS**, **NodeJS**, and **MongoDB**. Collaborating with diverse teams using platforms like GitHub and Bitbucket has honed my communication and teamwork skills.
